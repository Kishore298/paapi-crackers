...
import { Settings, Save, ShoppingBag, Truck, Percent } from 'lucide-react';
        ...
        <div className="card p-6 lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 lg:col-span-3">
              ...
              <textarea rows={4} value={settings.business.address} onChange={e => handleChange('business', 'address', e.target.value)} className="input-field resize-none"></textarea>
            </div>
          </div>
        </div>
